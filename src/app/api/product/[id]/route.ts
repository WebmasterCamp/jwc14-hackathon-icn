...
const updateEquipmentSchema = z.object({
  ...
  rentPriceDaily: z.number().positive().nullable().optional(),
  rentPriceWeekly: z.number().positive().nullable().optional(),
  rentPriceMonthly: z.number().positive().optional(),
  rentPriceYearly: z.number().positive().nullable().optional(),
