...
const providerSchema = z.object({
  ...
  companyName: z.string().min(2, "กรุณากรอกชื่อบริษัท"),
      ...
      <CardHeader className="space-y-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription>กรอกข้อมูลบริษัทของคุณ</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-4">
            <h3 className="font-medium text-sm text-muted-foreground">ข้อมูลผู้ใช้</h3>
          ...
          <div className="space-y-4">
            <h3 className="font-medium text-sm text-muted-foreground">ข้อมูลบริษัท</h3>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="description"
                placeholder="อธิบายเกี่ยวกับบริษัทและประเภทอุปกรณ์ที่ให้บริการ"
